...
-- -----------------------------------------------------
-- Table `shift_db`.`classes_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shift_db`.`classes_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `shift_db`.`classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shift_db`.`classes` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_classes_classes_type1`
    ...
    REFERENCES `shift_db`.`classes_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `shift_db`.`request` (
  ...
  CONSTRAINT `fk_request_subject1`
    ...
    REFERENCES `shift_db`.`classes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
